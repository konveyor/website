...
const CommunityLinks = () => {
  ...
  const github = site.siteMetadata.socialMedia.filter(
    (media) => media.platform === 'github',
  )[0].url
  ...
  return (
    <section className="get-involved z-0 relative bg-base-200 py-16 lg:pt-24 lg:pb-40 after:z-[-1] after:text-transparent after:bg-low-poly after:rotate-180 after:bg-no-repeat after:w-full after:absolute after:h-full after:top-0 after:bg-left-bottom after:opacity-60 before:opacity-60 before:transform before:z-[-1] before:bg-low-poly before:bg-no-repeat before:text-transparent before:w-full before:absolute before:h-full before:top-0 before:bg-left-bottom overflow-hidden">
      <div className="page-wrapper">
        ...
        <div className="md:mb-8 lg:mb-12 flex flex-wrap justify-center gap-4 md:gap-6 xl:gap-8">
          <Card.Root>
            <Card.Header>
            ...
            <Card.Body>
              Practitioners share migration strategies, lessons learned, and
              tools used at community live virtual meetups.{' '}
            </Card.Body>
            <Card.Footer>
          ...
          <Card.Root>
            ...
            <Card.Body>
              Have questions about your migration project or how to use our
              tools? Ping us on Slack.
            </Card.Body>
            <Card.Footer>
          ...
          <Card.Root>
            ...
            <Card.Body>
              Use Konveyor tools and submit pull requests to help improve these
              open source tools.
            </Card.Body>
            <Card.Footer>
          ...
          <Card.Root>
            <Card.Header>
              ...
              <KonveyorIconWh alt="" className="hidden dark:block h-10" />{' '}
              Konveyor Blog
            </Card.Header>
            <Card.Body>
              Read articles on how practitioners bring existing applications to
              Kubernetes at scale and updates on Konveyor tools.
            </Card.Body>
            <Card.Footer>

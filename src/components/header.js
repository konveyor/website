...
import { ReactComponent as Logo } from '../images/Konveyor-logo-color.svg'
import { ReactComponent as LogoDark } from '../images/Konveyor-logo.svg'
  ...
  return (
    <>
      ...
      <header className="top-0 sticky z-50 flex flex-col w-full border-b border-base-300">
        <div className="w-full order-2 h-14 md:h-[4.5rem] bg-base-100 dark:bg-base-0">
          <nav className="w-full flex items-center justify-between h-full page-wrapper">
            ...
            <div className="flex gap-3 lg:gap-4 items-center">
              <span className="hidden ml-4 md:flex">
                <SearchBar />
              </span>
        ...
        <div className="bg-primary-800 flex text-base-100 items-center dark:bg-primary-200 dark:text-primary-800 w-full h-10">

...
const SignUpForm = () => {
  ...
  const headingStyle = 'font-headings text-2xl lg:text-3xl text-primary-800 mb-2 mb-4 md:mb-8'
  const subheadingStyle =
    'font-headings text-xl lg:text-2xl text-primary-800 mt-4 mb-2 md:mt-0 lg:mb-4'
  const paragraphStyle =
    'mb-4 text-lg lg:text-xl text-base-800 lg:leading-relaxed max-w-[50ch] md:max-w-none'
  ...
  return (
    <>
      {subscribed ? (
        ...
        <section
          id="sign-up"
          className="z-1 my-12 md:my-24 page-wrapper flex flex-col md:flex-row md:gap-12"
        >
          <div className="md:w-1/2">
            <div className="mb-4 rounded-2xl border-2 border-base-400 bg-secondary-200 dark:bg-base-300 p-4 lg:p-8 pb-0">

...
import { ReactComponent as Icon1 } from '../../images/forklift/icon-01.svg'
import { ReactComponent as Icon2 } from '../../images/forklift/icon-02.svg'
import { ReactComponent as Icon3 } from '../../images/forklift/icon-03.svg'
    ...
    <>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 my-20 md:my-12 gap-8 page-wrapper">
          <div className="text-center">
            ...
            <p className={paragraphStyle}>
              Validate the compatibility of your virtual machine before executing your migration
            </p>
          </div>
          <div className="text-center">
            <p className="inline-block h-24 mb-4 text-primary-800">
            ...
            <p className={paragraphStyle}>
              Reduce downtime by using warm migration capabilities, which will pre-copy your data
      ...
      <section className="page-wrapper py-8 md:py-20 flex flex-col items-center">
        ...
        <p className={ledeStyle}>
          Forklift provides a simplistic way to migrate your virtual machines at scale to Kubernetes
          from traditional hypervisors like VMware and Red Hat Virtualization. Forklift is based on
          core linux v2v technologies that have been proven for years.
        </p>

...
![Companies intend to replatform, refactor, or repurchase just over half of their custom legacy applications. Expectations vary somewhat by region, with those in the UK and APAC planning to rehost or repurchase a greater proportion than those in the US.](../images/mod-report-2.png)
...
![Differences by region.](../images/mod-report-3.png)
...
![Companies plan to measure success of application modernization based on increased reliability and increased scalability. Those in APAC will also refer to improved security and customer satisfaction as success metrics.](../images/mod-report-4.png)
...
![More companies expect to have AI/ML software, data caching tools, and high-performance computing workloads in place in the next two years.](../images/mod-report-5.png)
...
![Companies expect a shift from public cloud toward private cloud deployment two years from now, especially in the UK and APAC.](../images/mod-report-6.png)
...
<iframe
  ...
  src="//www.slideshare.net/slideshow/embed_code/key/EbeD6UYMLMioWf"
  frameborder="0"
  allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowfullscreen
></iframe>

[Automate The Creation/Transformation of Infrastructure as Code Artifacts with Konveyor Move2Kube](https://www.slideshare.net/KonveyorIO/automate-the-creationtransformation-of-infrastructure-as-code-artifacts-with-konveyor-move2kube) from [Konveyor Community](https://www.slideshare.net/KonveyorIO)

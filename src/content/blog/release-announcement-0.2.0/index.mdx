...
date: 2023-06-30
description: >-
  Konveyor v0.2.0 Release Announcement
featured: false
tags:
  - Konveyor, Kubernetes, AppModernization
title: Konveyor v0.2.0 Release Announcement
---
We are thrilled to announce the release of Konveyor 0.2.0! This release supports various features, like migration waves, integration with Jira,
and other valuable minor updates.

Key Highlights of Konveyor 0.2.0:
* Migration waves
* Jira Integration
* Minor improvements

### :sparkles:  Migration Waves:
...
:sparkles: ServiceMonitor for hub metrics: We have introduced ServiceMonitor functionality to capture and monitor hub metrics, providing valuable insights into the performance of your system.

:sparkles: Expose Hub metrics: With this update, we have exposed hub metrics, allowing users to access and utilize metrics for monitoring and analysis purposes.

:sparkles: Make Ingress Creation Optional: This update allows Ingress creation optional, providing flexibility and control over your deployment configurations.

:sparkles: Support for Amazon Load Balancer Ingress controller: Our platform now supports the Amazon Load Balancer Ingress controller, enabling Konveyor to be easily deployed on EKS clusters.

:sparkles: Provide openshift-oauth as an authentication option: As part of our ongoing efforts to enhance authentication capabilities, we now offer openshift-oauth as an additional authentication option, providing more choices to meet your specific requirements.

:sparkles: Make rwx_supported false by default: In this release, we have set the default value of rwx_supported to false.

These minor improvements reflect our commitment to continuously refining and enhancing our platform to deliver an optimized and user-friendly experience. We value your feedback and encourage you to explore these enhancements as you leverage our latest release. You can install Konveyor 0.2.0 from [community operators](https://operatorhub.io/operator/konveyor-operator). If you encounter any issues or have suggestions for features, we encourage you to open an issue [here](https://github.com/konveyor/tackle2-operator/issues/new).
